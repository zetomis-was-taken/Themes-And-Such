                      ...
                      {c.subClasses.map((sc, scIdx) => (
                        <div key={scIdx} className="text-sm bg-muted/30 p-2 rounded border border-border/50">
                          ...
                          <div className="flex justify-between items-center">
                            <span>Thứ <span className="text-amber-600 dark:text-amber-500 font-bold">{sc.schedule.dayOfWeek}</span></span>
                            <span>Tiết <span className="text-blue-600 dark:text-blue-400 font-bold">{sc.schedule.startPeriod}-{sc.schedule.endPeriod}</span></span>
                          </div>
                          {sc.schedule.room && (
